...
public:
    ...
    int getNumOfJoysticks( void ) const;
	...
	bool isButtonDown(int joystick, int button) const;
	bool isPovDown(int joystick, int axis, int pov) const;
	bool isSliderDown(int joystick, int pov) const;
	int getAxisValue(int joystick, int axis) const;
...
private:
	...
	bool mJoystickButtonPressed;
	OIS::KeyCode mLastKeyPressed;
